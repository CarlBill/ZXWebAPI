...
namespace PublicClass
{
    ...
    public static class SqlDbHelper
    {
        ...
        // 连接字符串
        private static string connectionString = "Data Source=47.92.51.7;Initial Catalog=DBCarLoan;Persist Security Info=True;User ID=sa;Pwd=qwer123456@";
        #endregion
        ...
        private static bool ExecuteNonQueryByProc(string cmdText, params SqlParameter[] commandParameters)
        {
        ...
        /// <param name="commandParameters">命令参数</param>
        /// <returns>Object类型值</returns>
        private static object ExecuteScalarByProc(string cmdText, params SqlParameter[] commandParameters)
        {
        ...
        /// <param name="commandParameters">命令参数</param>
        /// <returns>DataSet类型值.</returns>
        private static DataSet ExecuteDataSetByProc(string cmdText, params SqlParameter[] commandParameters)
        {
        ...
        /// <param name="commandParameters">命令参数</param>
        /// <returns>DataTable类型值</returns>
        private static DataTable ExecuteDataTableByProc(string cmdText, params SqlParameter[] commandParameters)
        {
